...
export function RegisterForm() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      ...
      router.push(
        `/${locale}/verify-otp?email=${encodeURIComponent(data.email)}`
      );
    } catch (error: unknown) {
    ...
    <form onSubmit={handleFormSubmit} className="space-y-4 sm:space-y-5 w-full">
      <div className="space-y-1.5 sm:space-y-2 w-full">
        ...
        <Input
          ...
          className="h-10 sm:h-11 px-3 text-sm sm:text-base bg-gray-100 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 focus:bg-white focus:outline-none transition-colors w-full"
          style={{ fontFamily: "Roboto, sans-serif" }}
        />
        {errors.name && (
      ...
      <div className="space-y-1.5 sm:space-y-2 w-full">
        ...
        <div className="relative">
          <Input
            ...
            className="h-10 sm:h-11 px-3 pr-10 text-sm sm:text-base bg-gray-100 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 focus:bg-white focus:outline-none transition-colors w-full"
            style={{ fontFamily: "Roboto, sans-serif" }}
          />
          <button
            type="button"
