...
export default function PacksPage() {
  ...
  const filterOptions = {
    ...
    priceRanges: [
      { label: t("price.free"), value: "free" },
      { label: t("price.under5m"), value: "0-5000000" },
      { label: t("price.5to10m"), value: "5000000-10000000" },
      { label: t("price.10to15m"), value: "10000000-15000000" },
      { label: t("price.over15m"), value: "15000000+" },
    ],
  };
  ...
  const sortOptions = [
    { value: "featured", label: t("sortOptions.featured"), icon: Sparkles },
    { value: "newest", label: t("sortOptions.newest") },
    { value: "rating", label: t("sortOptions.rating"), icon: Star },
    { value: "popular", label: t("sortOptions.popular"), icon: TrendingUp },
          ...
          <div className="px-4 sm:px-6 lg:px-16 py-12 sm:py-16 md:py-20 lg:py-20 xl:py-24">
            ...
            <div className="mb-6">
              <nav className="flex items-center gap-2 text-sm text-gray-500">
                <a href={`/${locale}/explore`} className="hover:text-gray-700">{t("breadcrumb")}</a>
                <span>/</span>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <p className="text-lg text-gray-600">
                  {t("subtitle", { count: totalPacks.toLocaleString() })}
                </p>
              </div>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mb-6">
                <p className="text-sm text-gray-600">
                  {t("showing", { count: packs.length, total: totalPacks.toLocaleString() })}
                </p>
              </div>
                  ...
                  >
                    {packs.map((pack) => (
                      <PackageCard
                        ...
                        package={pack}
                        onConsultClick={() => {
                          // TODO: Implement consult click handler
                        }}
                      />
                    ))}
                  </div>
