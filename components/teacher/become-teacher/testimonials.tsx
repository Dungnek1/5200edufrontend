...
interface BecomeTeacherTestimonialsProps {
...
export function BecomeTeacherTestimonials({ testimonialsRef, isPaused, setIsPaused, scrollTestimonials }: BecomeTeacherTestimonialsProps) {
  const t = useTranslations("page.becomeTeacher");

  const testimonials = [
    { name: t("testimonial1Name"), role: t("testimonial1Role"), comment: t("testimonial1Comment") },
    { name: t("testimonial2Name"), role: t("testimonial2Role"), comment: t("testimonial2Comment") },
    { name: t("testimonial3Name"), role: t("testimonial3Role"), comment: t("testimonial3Comment") },
    { name: t("testimonial4Name"), role: t("testimonial4Role"), comment: t("testimonial4Comment") },
    { name: t("testimonial5Name"), role: t("testimonial5Role"), comment: t("testimonial5Comment") },
    { name: t("testimonial6Name"), role: t("testimonial6Role"), comment: t("testimonial6Comment") },
    { name: t("testimonial7Name"), role: t("testimonial7Role"), comment: t("testimonial7Comment") },
    { name: t("testimonial8Name"), role: t("testimonial8Role"), comment: t("testimonial8Comment") },
    { name: t("testimonial9Name"), role: t("testimonial9Role"), comment: t("testimonial9Comment") },
    { name: t("testimonial10Name"), role: t("testimonial10Role"), comment: t("testimonial10Comment") },
    { name: t("testimonial11Name"), role: t("testimonial11Role"), comment: t("testimonial11Comment") },
    { name: t("testimonial12Name"), role: t("testimonial12Role"), comment: t("testimonial12Comment") },
    { name: t("testimonial13Name"), role: t("testimonial13Role"), comment: t("testimonial13Comment") },
    { name: t("testimonial14Name"), role: t("testimonial14Role"), comment: t("testimonial14Comment") },
    { name: t("testimonial15Name"), role: t("testimonial15Role"), comment: t("testimonial15Comment") },
  ];

  return (
    <section className="bg-white py-12 sm:py-16 md:py-20 lg:py-20 xl:py-[40px] px-4 sm:px-6 lg:px-16">
      <div className="w-full">
        ...
        {/* Navigation Buttons */}
        <div className="flex justify-center gap-2 sm:gap-3 lg:gap-3 mb-4 sm:mb-6 md:mb-8 lg:mb-8">
          <button
            onClick={() => scrollTestimonials("left")}
            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:bg-[#eceffd] transition-colors shadow-sm cursor-pointer"
          >
              ...
              <div className="flex items-center gap-2 sm:gap-3 lg:gap-3 pt-3 sm:pt-4 lg:pt-4 border-t border-[#f3f4f6]">
                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-14 lg:h-14 rounded-full bg-[#4162e7] flex-shrink-0 relative">
                  <div className="absolute -bottom-0.5 sm:-bottom-1 lg:-bottom-1 -right-0.5 sm:-right-1 lg:-right-1 w-4 h-4 sm:w-5 sm:h-5 lg:w-5 lg:h-5 rounded-full flex items-center justify-center">
                    ...
                    >
                      <mask id="verified-badge-become-teacher" fill="white">
                      ...
                      <path
                        ...
                        fill="url(#paint0_linear_verified_become_teacher)"
                      />
                      <path
                        ...
                        fill="white"
                        mask="url(#verified-badge-become-teacher)"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                      ...
                      <defs>
                        <linearGradient
                          id="paint0_linear_verified_become_teacher"
                          x1="0"
                          y1="0"
                          x2="20"
                          y2="20"
